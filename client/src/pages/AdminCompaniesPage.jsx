...
import { Building2, Trash2, ToggleLeft, ToggleRight, Loader2, Users, PlusCircle } from 'lucide-react'
...
export function AdminCompaniesPage() {
  ...
  const [expanded, setExpanded] = useState(null)   // company id whose users are shown
  const [companyUsers, setCompanyUsers] = useState({}) // { [companyId]: user[] }
